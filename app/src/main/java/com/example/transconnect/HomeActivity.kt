...
import com.example.transconnect.route.RouteActivity
...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.listterminal-> {
                Intent(this@HomeActivity, ListTerminalActivity::class.java).also {
                    startActivity(it)
                }
            }

            R.id.findroute-> {
                Intent(this@HomeActivity, RouteActivity::class.java).also {
                    startActivity(it)
                }
            }
            else -> return true
